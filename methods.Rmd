...
The biological data layer was comprised by three different species biodiversity indicators. A fish species biodiversity summary product already existed for the North Sea. For cetaceans and seabirds biodiversity indicators, the study relied on species distribution models produced for a list of species given to and created by HUB Ocean. In total, species distribution models 13 cetacean species and 53 seabird species created the biodiversity indicators for the cetacean group and seabird group. These three biodiversity indicators combined to create a submodel for the final nature index.
