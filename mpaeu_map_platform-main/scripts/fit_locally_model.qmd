...
pred_model <- function(model, pred_out, species, outacro) {
    ...
    outmess <- fs::path(pred_out, paste0("taxonid=", species, "_model=", outacro, "_what=mess.tif"))
    outshape <- fs::path(pred_out, paste0("taxonid=", species, "_model=", outacro, "_what=shape.tif"))
    ...
    for (k in 1:nrow(scenarios)) {
        ...
        outpred <- fs::path(pred_out, paste0(
